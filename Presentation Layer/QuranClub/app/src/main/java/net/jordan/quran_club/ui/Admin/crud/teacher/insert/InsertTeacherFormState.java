...
public class InsertTeacherFormState {
        @Nullable
    ...
    InsertTeacherFormState(@Nullable Integer usernameError
                , @Nullable Integer passwordError
        ) {
            this.usernameError = usernameError;
            this.passwordError = passwordError;
    ...
    InsertTeacherFormState(boolean isDataValid) {
