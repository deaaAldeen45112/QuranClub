...
public class InsertStudentFormState {
    @Nullable
    ...
    InsertStudentFormState(@Nullable Integer usernameError
            , @Nullable Integer passwordError
            ) {
        this.usernameError = usernameError;
        this.passwordError = passwordError;
    ...
    InsertStudentFormState(boolean isDataValid) {
