...
if ($_SERVER['REQUEST_METHOD'] === 'GET') { 
  ...
  $student_lesson_quran_part_surah->student_id = $_GET["studentId"];
  // Blog post query
  $result = $student_lesson_quran_part_surah->read_studentLessonQuranPartSurah_join_studentLesson_join_userlogin_by_student_id();
  // Get row count
  $num = $result->rowCount();
